...
/// to create a faucet.
module fungible_coin::treasury_lock {
...
#[test_only]
module fungible_coin::treasury_lock_tests {
    use std::option;
    ...
    use sui::object::{Self};
    use sui::test_utils;
    use fungible_coin::treasury_lock::{Self, TreasuryLock, LockAdminCap, MintCap, create_and_transfer_mint_cap, new_lock, mint_balance};
